...
namespace OpenTK.Windowing.Common
{
    ...
    public readonly struct MonitorEventArgs(MonitorHandle monitor, bool isConnected) // TODO: merge with JoystickEventArgs?
    {

        /// <summary>
        /// Gets the <see cref="Monitor"/> which triggered the event.
        /// </summary>
        public MonitorHandle Monitor { get; } = monitor;
